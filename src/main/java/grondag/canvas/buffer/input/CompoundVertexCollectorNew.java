...
public class CompoundVertexCollectorNew extends BaseVertexCollector {
	private final VertexBucketFunction bucketFunction;
	private final int bucketCount;
	private final SimpleVertexCollector[] collectors;

	public CompoundVertexCollectorNew(RenderState renderState, boolean isTerrain, int[] target) {
