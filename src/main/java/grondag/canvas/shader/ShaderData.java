...
public class ShaderData {
	...
	public static final Identifier DEFAULT_ENTITY_VERTEX = new Identifier("canvas:shaders/entity/default.vert");
	public static final Identifier DEFAULT_ENTITY_FRAGMENT = new Identifier("canvas:shaders/entity/default.frag");
