...
public class VanillaAoCalc {
   ...
   private int getBrightness(int int_1, int int_2, int int_3, int int_4, float float_1, float float_2, float float_3, float float_4) {
    ...
    public static void updateShape(ExtendedBlockView extendedBlockView_1, BlockState blockState_1, BlockPos blockPos_1, int[] ints_1, Direction direction_1, float[] aoBounds, BitSet bitSet_1) {
        float float_1 = 32.0F;
        float float_2 = 32.0F;
        float float_3 = 32.0F;
        float float_4 = -32.0F;
        ...
        case DOWN:
           ...
           bitSet_1.set(0, (float_2 < 1.0E-4F || blockState_1.method_11604(extendedBlockView_1, blockPos_1)) && float_2 == float_5);
           break;
        case UP:
           bitSet_1.set(1, float_1 >= 1.0E-4F || float_3 >= 1.0E-4F || float_4 <= 0.9999F || float_6 <= 0.9999F);
           bitSet_1.set(0, (float_5 > 0.9999F || blockState_1.method_11604(extendedBlockView_1, blockPos_1)) && float_2 == float_5);
           break;
        case NORTH:
           bitSet_1.set(1, float_1 >= 1.0E-4F || float_2 >= 1.0E-4F || float_4 <= 0.9999F || float_5 <= 0.9999F);
           bitSet_1.set(0, (float_3 < 1.0E-4F || blockState_1.method_11604(extendedBlockView_1, blockPos_1)) && float_3 == float_6);
           break;
        case SOUTH:
           bitSet_1.set(1, float_1 >= 1.0E-4F || float_2 >= 1.0E-4F || float_4 <= 0.9999F || float_5 <= 0.9999F);
           bitSet_1.set(0, (float_6 > 0.9999F || blockState_1.method_11604(extendedBlockView_1, blockPos_1)) && float_3 == float_6);
           break;
        case WEST:
           bitSet_1.set(1, float_2 >= 1.0E-4F || float_3 >= 1.0E-4F || float_5 <= 0.9999F || float_6 <= 0.9999F);
           bitSet_1.set(0, (float_1 < 1.0E-4F || blockState_1.method_11604(extendedBlockView_1, blockPos_1)) && float_1 == float_4);
           break;
        case EAST:
           bitSet_1.set(1, float_2 >= 1.0E-4F || float_3 >= 1.0E-4F || float_5 <= 0.9999F || float_6 <= 0.9999F);
           bitSet_1.set(0, (float_4 > 0.9999F || blockState_1.method_11604(extendedBlockView_1, blockPos_1)) && float_1 == float_4);
        }
