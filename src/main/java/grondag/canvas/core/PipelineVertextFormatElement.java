...
//    public static final PipelineVertextFormatElement LIGHTMAPS_2S = new PipelineVertextFormatElement(2, VertexFormatElement.EnumType.SHORT, VertexFormatElement.EnumUsage.GENERIC, 2, "in_lightmap", false);
     ...
     * coordinates<br>
     * 3rd byte is has control flags. bits 0-2 are emissive flags, bit 3 controls
     * mimmaping (1=off), bit 4 is cutout<br>
     * bits 5-7 and the last byte are reserved
     * 
     * In enhanced lighting model, bytes 1-3 are rgb light color/glow flag, and the
     * last byte is amount of torch flicker. The most significant bit of the rgb
     * color bytes indicates if layers are emissive. The color values are thus scale
     * to 0-127 and need to be normalized in the shader after stripping the glow
     * bit.
     * <p>
     */
    ...
    // UGLY: index in for generic attributes misaligned now due to mismatched usage
    // in vanilla vs extended formats
    // (doesn't currently matter)
    public static final PipelineVertextFormatElement NORMAL_AO_4UB = new PipelineVertextFormatElement(0,
            VertexFormatElement.Format.UNSIGNED_BYTE, VertexFormatElement.Type.PADDING, 4, "in_normal_ao", false);

    public static final PipelineVertextFormatElement SECONDARY_RGBA_4UB = new PipelineVertextFormatElement(3,
            VertexFormatElement.Format.UNSIGNED_BYTE, VertexFormatElement.Type.PADDING, 4, "in_color_1");
    public static final PipelineVertextFormatElement SECONDARY_TEX_2F = new PipelineVertextFormatElement(4,
            VertexFormatElement.Format.FLOAT, VertexFormatElement.Type.PADDING, 2, "in_uv_1");

    public static final PipelineVertextFormatElement TERTIARY_RGBA_4UB = new PipelineVertextFormatElement(5,
            VertexFormatElement.Format.UNSIGNED_BYTE, VertexFormatElement.Type.PADDING, 4, "in_color_2");
    public static final PipelineVertextFormatElement TERTIARY_TEX_2F = new PipelineVertextFormatElement(6,
