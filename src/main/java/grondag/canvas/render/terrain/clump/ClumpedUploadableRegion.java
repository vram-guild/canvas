...
public class ClumpedUploadableRegion implements UploadableRegion {
	...
	public ClumpedUploadableRegion(VertexCollectorList collectorList, boolean sorted, int bytes, long packedOriginBlockPos) {
		drawable = ClumpedDrawableRegion.pack(collectorList, sorted, bytes, packedOriginBlockPos);
	}
