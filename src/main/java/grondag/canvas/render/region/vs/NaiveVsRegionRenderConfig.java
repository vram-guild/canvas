...
public class NaiveVsRegionRenderConfig extends RegionRenderConfig {
	public static final NaiveVsRegionRenderConfig INSTANCE = new NaiveVsRegionRenderConfig();

	private NaiveVsRegionRenderConfig() {
		super(
			VsFormat.VS_MATERIAL,
			VsFormat.VS_MATERIAL.quadStrideInts,
			true,
			VsFormat.VS_TRANSCODER,
			NaiveVsDrawList::build
		);
	}
