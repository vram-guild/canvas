...
public class RegionSectorMap {
	...
	private static final int MAX_SECTORS_LOADED = SECTOR_XZ_DIAMETER * SECTOR_XZ_DIAMETER * SECTOR_Y_DIAMETER;
	...
	private final short[] sectorOffsets = new short[MAX_SECTORS_LOADED];
	...
	public class RenderSector {
		...
		private void updateCameraDependentValues() {
			...
			sectorOffsets[sectorId] = (short) (xOffset | (sectorOriginY << 4) | (zOffset << 8));
		}
