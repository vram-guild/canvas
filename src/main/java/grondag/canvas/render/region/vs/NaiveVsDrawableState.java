...
public class NaiveVsDrawableState extends AbstractDrawableState<NaiveVsDrawableStorage> {
	private final int triVertexCount;

	public NaiveVsDrawableState(RenderState renderState, int quadVertexCount, NaiveVsDrawableStorage storage) {
