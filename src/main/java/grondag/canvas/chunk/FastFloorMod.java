 ...
 * About 50% faster than standard routines on Intel i7 w/ JVM 8.<p>
 *
 * Exploits fact that block X, Z coordinates are in range +/- 30000000
 * to avoid special casing for negative values.
 *
 * See https://www.agner.org/optimize/optimizing_assembly.pdf for math.
 */
public class FastFloorMod {
	...
	private static IntUnaryOperator RADIUS_4 = x  -> {
		x += OFFSET_4;
	...
	private static IntUnaryOperator RADIUS_5 = x  -> {
		x += OFFSET_5;
	...
	private static IntUnaryOperator RADIUS_6 = x  -> {
		x += OFFSET_6;
	...
	private static IntUnaryOperator RADIUS_7 = x  -> {
		x += OFFSET_7;
	...
	private static IntUnaryOperator RADIUS_8 = x  -> {
		x += OFFSET_8;
	...
	private static IntUnaryOperator RADIUS_9 = x  -> {
		x += OFFSET_9;
	...
	private static IntUnaryOperator RADIUS_10 = x  -> {
		x += OFFSET_10;
	...
	private static IntUnaryOperator RADIUS_11 = x  -> {
		x += OFFSET_11;
	...
	private static IntUnaryOperator RADIUS_12 = x  -> {
		x += OFFSET_12;
	...
	private static IntUnaryOperator RADIUS_13 = x  -> {
		x += OFFSET_13;
	...
	private static IntUnaryOperator RADIUS_14 = x  -> {
		x += OFFSET_14;
	...
	private static IntUnaryOperator RADIUS_15 = x  -> {
		x += OFFSET_15;
	...
	private static IntUnaryOperator RADIUS_16 = x  -> {
		x += OFFSET_16;
	...
	private static IntUnaryOperator RADIUS_17 = x  -> {
		x += OFFSET_17;
	...
	private static IntUnaryOperator RADIUS_18 = x  -> {
		x += OFFSET_18;
	...
	private static IntUnaryOperator RADIUS_19 = x  -> {
		x += OFFSET_19;
	...
	private static IntUnaryOperator RADIUS_20 = x  -> {
		x += OFFSET_20;
	...
	private static IntUnaryOperator RADIUS_21 = x  -> {
		x += OFFSET_21;
	...
	private static IntUnaryOperator RADIUS_22 = x  -> {
		x += OFFSET_22;
	...
	private static IntUnaryOperator RADIUS_23 = x  -> {
		x += OFFSET_23;
	...
	private static IntUnaryOperator RADIUS_24 = x  -> {
		x += OFFSET_24;
	...
	private static IntUnaryOperator RADIUS_25 = x  -> {
		x += OFFSET_25;
	...
	private static IntUnaryOperator RADIUS_26 = x  -> {
		x += OFFSET_26;
	...
	private static IntUnaryOperator RADIUS_27 = x  -> {
		x += OFFSET_27;
	...
	private static IntUnaryOperator RADIUS_28 = x  -> {
		x += OFFSET_28;
	...
	private static IntUnaryOperator RADIUS_29 = x  -> {
		x += OFFSET_29;
	...
	private static IntUnaryOperator RADIUS_30 = x  -> {
		x += OFFSET_30;
	...
	private static IntUnaryOperator RADIUS_31 = x  -> {
		x += OFFSET_31;
	...
	private static IntUnaryOperator RADIUS_32 = x  -> {
		x += OFFSET_32;
