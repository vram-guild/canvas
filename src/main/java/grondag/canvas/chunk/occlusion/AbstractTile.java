...
import static grondag.canvas.chunk.occlusion._Constants.INSIDE;
import static grondag.canvas.chunk.occlusion._Constants.INTERSECTING;
...
import static grondag.canvas.chunk.occlusion._Constants.LOW_TILE_SPAN;
import static grondag.canvas.chunk.occlusion._Constants.MID_AXIS_SHIFT;
import static grondag.canvas.chunk.occlusion._Constants.MID_TILE_SPAN;
import static grondag.canvas.chunk.occlusion._Constants.OUTSIDE;
...
import static grondag.canvas.chunk.occlusion._Data.hiExtent0;
import static grondag.canvas.chunk.occlusion._Data.hiExtent1;
import static grondag.canvas.chunk.occlusion._Data.hiExtent2;
import static grondag.canvas.chunk.occlusion._Data.hiSpanA0;
import static grondag.canvas.chunk.occlusion._Data.hiSpanA1;
import static grondag.canvas.chunk.occlusion._Data.hiSpanA2;
import static grondag.canvas.chunk.occlusion._Data.hiSpanB0;
import static grondag.canvas.chunk.occlusion._Data.hiSpanB1;
import static grondag.canvas.chunk.occlusion._Data.hiSpanB2;
import static grondag.canvas.chunk.occlusion._Data.hiStepA0;
import static grondag.canvas.chunk.occlusion._Data.hiStepA1;
import static grondag.canvas.chunk.occlusion._Data.hiStepA2;
import static grondag.canvas.chunk.occlusion._Data.hiStepB0;
import static grondag.canvas.chunk.occlusion._Data.hiStepB1;
import static grondag.canvas.chunk.occlusion._Data.hiStepB2;
import static grondag.canvas.chunk.occlusion._Data.lowExtent0;
import static grondag.canvas.chunk.occlusion._Data.lowExtent1;
import static grondag.canvas.chunk.occlusion._Data.lowExtent2;
import static grondag.canvas.chunk.occlusion._Data.lowSpanA0;
import static grondag.canvas.chunk.occlusion._Data.lowSpanA1;
import static grondag.canvas.chunk.occlusion._Data.lowSpanA2;
import static grondag.canvas.chunk.occlusion._Data.lowSpanB0;
import static grondag.canvas.chunk.occlusion._Data.lowSpanB1;
import static grondag.canvas.chunk.occlusion._Data.lowSpanB2;
...
import static grondag.canvas.chunk.occlusion._Data.positionHi0;
import static grondag.canvas.chunk.occlusion._Data.positionHi1;
import static grondag.canvas.chunk.occlusion._Data.positionHi2;
import static grondag.canvas.chunk.occlusion._Data.positionLow0;
import static grondag.canvas.chunk.occlusion._Data.positionLow1;
import static grondag.canvas.chunk.occlusion._Data.positionLow2;
import static grondag.canvas.chunk.occlusion._Data.save_lowTileX;
import static grondag.canvas.chunk.occlusion._Data.save_lowTileY;
import static grondag.canvas.chunk.occlusion._Data.save_midTileX;
import static grondag.canvas.chunk.occlusion._Data.save_midTileY;
import static grondag.canvas.chunk.occlusion._Data.save_positionHi0;
import static grondag.canvas.chunk.occlusion._Data.save_positionHi1;
import static grondag.canvas.chunk.occlusion._Data.save_positionHi2;
import static grondag.canvas.chunk.occlusion._Data.save_positionLow0;
import static grondag.canvas.chunk.occlusion._Data.save_positionLow1;
import static grondag.canvas.chunk.occlusion._Data.save_positionLow2;
import static grondag.canvas.chunk.occlusion._Data.save_x0y0Hi0;
import static grondag.canvas.chunk.occlusion._Data.save_x0y0Hi1;
import static grondag.canvas.chunk.occlusion._Data.save_x0y0Hi2;
import static grondag.canvas.chunk.occlusion._Data.save_x0y0Low0;
import static grondag.canvas.chunk.occlusion._Data.save_x0y0Low1;
import static grondag.canvas.chunk.occlusion._Data.save_x0y0Low2;
import static grondag.canvas.chunk.occlusion._Data.x0y0Hi0;
import static grondag.canvas.chunk.occlusion._Data.x0y0Hi1;
import static grondag.canvas.chunk.occlusion._Data.x0y0Hi2;
import static grondag.canvas.chunk.occlusion._Data.x0y0Low0;
import static grondag.canvas.chunk.occlusion._Data.x0y0Low1;
import static grondag.canvas.chunk.occlusion._Data.x0y0Low2;
