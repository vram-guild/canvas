...
public class FastRenderRegion implements RenderAttachedBlockView {
	...
	public BlockEntity getBlockEntity(BlockPos pos, WorldChunk.CreationType creationType) {
		final int int_1 = (pos.getX() >> 4) - chunkXOffset;
		final int int_2 = (pos.getZ() >> 4) - chunkZOffset;
		return chunks[int_1][int_2].getBlockEntity(pos, creationType);
	}
	...
	public Biome getBiome(BlockPos pos) {
		final int int_1 = (pos.getX() >> 4) - chunkXOffset;
		final int int_2 = (pos.getZ() >> 4) - chunkZOffset;
		return chunks[int_1][int_2].getBiome(pos);
	}
	...
	public int cachedBrightness(BlockPos pos) {
		final long key = PackedBlockPos.pack(pos);
