...
public class VfIndexTexture<T extends VfIndexElement<T>> {
	...
	public VfIndexTexture(int textureUnit, int imageFormat, int intsPerElement) {
	...
	protected void createImageIfNeeded() {
		if (image == null) {
			try {
				image = new VfIndexImage<>(intsPerElement);
