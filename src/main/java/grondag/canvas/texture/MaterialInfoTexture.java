...
public class MaterialInfoTexture {
	...
	private static final Object2ObjectOpenHashMap<Identifier, MaterialInfoTexture> MAP = new Object2ObjectOpenHashMap<>(64, Hash.VERY_FAST_LOAD_FACTOR);

	public static final MaterialInfoTexture getOrCreate(Identifier id) {
		return MAP.computeIfAbsent(id, MaterialInfoTexture::new);
	}

	public static final MaterialInfoTexture BLOCKS = getOrCreate(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE);
	...
	private MaterialInfoTexture(Identifier id) {
		this.id = id;
	}
