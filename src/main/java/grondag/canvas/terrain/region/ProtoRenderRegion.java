...
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_000;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_002;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_020;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_022;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_200;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_202;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_220;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_INDEX_222;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_I_MASK;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_J_MASK;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_J_SHIFT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_K_SHIFT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.CORNER_STATE_COUNT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Y0X0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Y0X2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Y2X0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Y2X2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z0X0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z0X2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z0Y0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z0Y2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z2X0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z2X2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z2Y0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_INDEX_Z2Y2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_I_MASK;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_J_MASK;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_J_SHIFT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_K_SHIFT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EDGE_STATE_COUNT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.EXTERIOR_STATE_COUNT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.FACE_I_MASK;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.FACE_J_MASK;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.FACE_J_SHIFT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.FACE_K_SHIFT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.FACE_STATE_COUNT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.INTERIOR_STATE_COUNT;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.SIDE_INDEX_X0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.SIDE_INDEX_X2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.SIDE_INDEX_Y0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.SIDE_INDEX_Y2;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.SIDE_INDEX_Z0;
import static grondag.canvas.terrain.util.RenderRegionAddressHelper.SIDE_INDEX_Z2;
