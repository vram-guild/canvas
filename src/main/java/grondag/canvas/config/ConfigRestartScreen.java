...
public class ConfigRestartScreen extends BaseScreen {
	...
	protected void init() {
		...
		this.addRenderableWidget(new Button(this.width / 2 + 1, this.height / 2 - 100 + lines.size() * 16 + 60, 160 - 2, 20, new TranslatableComponent("config.canvas.restart.ignore"), b -> onClose()));
	}
