...
package grondag.canvas.renderer.mesh;

import static grondag.canvas.renderer.mesh.EncodingFormat.HEADER_BITS;
import static grondag.canvas.renderer.mesh.EncodingFormat.HEADER_COLOR_INDEX;
import static grondag.canvas.renderer.mesh.EncodingFormat.HEADER_STRIDE;
import static grondag.canvas.renderer.mesh.EncodingFormat.HEADER_TAG;
import static grondag.canvas.renderer.mesh.EncodingFormat.QUAD_STRIDE;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_COLOR;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_LIGHTMAP;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_NORMAL;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_STRIDE;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_U;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_V;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_X;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_Y;
import static grondag.canvas.renderer.mesh.EncodingFormat.VERTEX_Z;
...
import grondag.canvas.renderer.RenderMaterialImpl;
import grondag.canvas.renderer.helper.GeometryHelper;
import grondag.canvas.renderer.helper.NormalHelper;
