...
import static grondag.canvas.renderer.mesh.EncodingFormat.EMPTY;
...
import grondag.canvas.renderer.RenderMaterialImpl.Value;
import grondag.canvas.renderer.helper.ColorHelper.ShadeableQuad;
import grondag.canvas.renderer.helper.GeometryHelper;
import grondag.canvas.renderer.helper.NormalHelper;
import grondag.canvas.renderer.helper.TextureHelper;
